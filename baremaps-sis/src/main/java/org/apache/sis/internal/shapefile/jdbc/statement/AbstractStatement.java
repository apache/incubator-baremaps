...
/**
 * This base class holds most of the unimplemented feature of a {@code Statement}. This is used in
 * order to avoid having a Statement implementation of thousand lines and unreadable.
 *
 * <table class="sis">
...
abstract class AbstractStatement extends AbstractJDBC implements Statement {
  ...
  /**
   * Default to {@link ResultSet#CONCUR_READ_ONLY}, which is a conservative vale meaning that the
   * underlying database should not be updated while we iterate in a result set.
   */
  @Override
  ...
  /**
   * Defaults to {@link ResultSet#CLOSE_CURSORS_AT_COMMIT}, which seems the most conservative
   * option.
   */
  @Override
