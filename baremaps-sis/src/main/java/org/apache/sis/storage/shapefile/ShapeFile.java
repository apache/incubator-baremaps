...
public class ShapeFile {
   ...
   */
  public InputFeatureStream findAll()
      throws InvalidDbaseFileFormatException, ShapefileNotFoundException,
   ...
   * @throws InvalidShapefileFormatException if the shapefile format is invalid.
   */
  public InputFeatureStream find(String sqlStatement)
      throws InvalidDbaseFileFormatException, ShapefileNotFoundException,
          DbaseFileNotFoundException, InvalidShapefileFormatException {
    InputFeatureStream is =
        new InputFeatureStream(
            this.shapeFile, this.databaseFile, this.shapeFileIndex, sqlStatement);
