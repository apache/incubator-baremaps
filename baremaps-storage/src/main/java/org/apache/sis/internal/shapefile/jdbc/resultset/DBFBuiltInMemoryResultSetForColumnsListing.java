    ...
    @Override public int getInt(String columnLabel) throws SQLNoSuchFieldException {
        switch(columnLabel) {
            ...
            default:
                ...
                throw new SQLNoSuchFieldException("No desc field", "asking columns desc", getFile(), columnLabel);
        }
    }
    ...
    @Override public boolean next() throws SQLNoResultException {
        if (this.itDescriptor.hasNext()) {
            ...
            if (this.afterLast) {
                ...
                throw new SQLNoResultException("No more desc", "asking columns desc", getFile());
            }
            else {
                return false;
            }
