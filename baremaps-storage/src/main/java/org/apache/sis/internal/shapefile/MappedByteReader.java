 ...
 * @since 0.5
 */
public class MappedByteReader extends
    CommonByteReader<SQLInvalidDbaseFileFormatException, SQLDbaseFileNotFoundException> implements AutoCloseable,
    Dbase3ByteReader {
  ...
  public MappedByteReader(File dbase3File, Properties connectionInfos)
    ...
    super(dbase3File, SQLInvalidDbaseFileFormatException.class, SQLDbaseFileNotFoundException.class);
