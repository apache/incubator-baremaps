...
public class Main {
  ...
  public static void main(String[] args) throws SQLException, IOException {
    ...
    CopyWriter writer = OsmNodes.createCopy((PGConnection) connection);
    OsmNodes.copy(writer, new OsmNodes.Row(5l, 1, 1, new Timestamp(2), 1l, new HashMap<>(), gf.createPoint(new Coordinate(1, 1))));
    ...
    OsmNodes.Row row = OsmNodes.select(connection, new OsmNodes.PrimaryKey(5l));
