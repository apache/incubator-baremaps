...
public class GeoParquetWriter extends ParquetWriter<GeoParquetGroupImpl> {
  ...
  public static class Builder extends ParquetWriter.Builder<GeoParquetGroupImpl, Builder> {
    ...
    @Override
    protected WriteSupport<GeoParquetGroupImpl> getWriteSupport(Configuration conf) {
