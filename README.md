...
- [Create an issue](https://github.com/apache/incubator-baremaps/issues): Report a bug or submit a feature request. All issues are tracked in the incubator-baremaps repository and organized using labels. For example, the "documentation" label is used for issues related to both the documentation and the website.
