        ...
        Arguments.of(new IntegerDataType(), Integer.MIN_VALUE),
                ...
                Arguments.of(new PolygonDataType(),
                        new GeometryFactory()
                                .createPolygon(
                                        new GeometryFactory()
                                                .createLinearRing(new Coordinate[]{new Coordinate(0, 0), new Coordinate(0, 3), new Coordinate(5, 3), new Coordinate(5, 0), new Coordinate(0, 0)}),
                                        new LinearRing[]{
                                                new GeometryFactory()
                                                        .createLinearRing(new Coordinate[]{new Coordinate(1, 1), new Coordinate(1, 2), new Coordinate(2, 2), new Coordinate(2, 1), new Coordinate(1, 1)}),
                                                new GeometryFactory()
                                                        .createLinearRing(new Coordinate[]{new Coordinate(3, 1), new Coordinate(3, 2), new Coordinate(4, 2), new Coordinate(4, 1), new Coordinate(3, 1)})})),
                                ...
                                .createMultiPolygon(
                                        new Polygon[]{
                                                ...
                                                new GeometryFactory()
                                                        .createPolygon(
                                                        new GeometryFactory()
                                                                .createLinearRing(new Coordinate[]{new Coordinate(1, 4), new Coordinate(1, 5), new Coordinate(2, 5), new Coordinate(2, 4), new Coordinate(1, 4)}))})),
