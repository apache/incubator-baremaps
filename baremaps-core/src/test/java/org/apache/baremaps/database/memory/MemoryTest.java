...
import static org.apache.baremaps.database.memory.MemoryProvider.SEGMENT_BYTES;
...
class MemoryTest {
  ...
  @ParameterizedTest
  @MethodSource("org.apache.baremaps.database.memory.MemoryProvider#memories")
