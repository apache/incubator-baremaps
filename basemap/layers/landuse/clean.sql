...
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_medium_filtered CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_medium_clustered CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_medium_grouped CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_medium_buffered CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_medium_exploded CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_medium CASCADE;

DROP MATERIALIZED VIEW IF EXISTS osm_landuse_small_filtered CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_small_clustered CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_small_grouped CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_small_buffered CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_small_exploded CASCADE;
DROP MATERIALIZED VIEW IF EXISTS osm_landuse_small CASCADE;
