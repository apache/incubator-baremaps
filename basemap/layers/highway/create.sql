...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 12)) AS geom FROM osm_highway_simplified) AS osm_highway
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 11)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 10)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 9)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 8)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 7)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 6)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 5)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 4)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 3)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 2)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
...
SELECT id, tags, geom
FROM (SELECT id, tags, st_simplifypreservetopology(geom, 78270 / power(2, 1)) AS geom FROM osm_highway_simplified) AS osm_highway
WHERE geom IS NOT NULL
  AND NOT ST_IsEmpty(geom)
