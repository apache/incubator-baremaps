...
CREATE INDEX IF NOT EXISTS osm_boundary_geom_z4_index ON osm_boundary_z4 USING SPGIST (geom);
CREATE INDEX IF NOT EXISTS osm_boundary_geom_z5_index ON osm_boundary_z5 USING SPGIST (geom);
CREATE INDEX IF NOT EXISTS osm_boundary_geom_z6_index ON osm_boundary_z6 USING SPGIST (geom);
CREATE INDEX IF NOT EXISTS osm_boundary_geom_z7_index ON osm_boundary_z7 USING SPGIST (geom);
CREATE INDEX IF NOT EXISTS osm_boundary_geom_z8_index ON osm_boundary_z8 USING SPGIST (geom);
CREATE INDEX IF NOT EXISTS osm_boundary_geom_z9_index ON osm_boundary_z9 USING SPGIST (geom);
