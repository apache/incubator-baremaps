  ...
  void testMaterializedView() throws SQLException, IOException {
    ...
    try (Connection connection = DriverManager.getConnection("jdbc:calcite:", info)) {
      ...
      DataSchema citySchema = new DataSchema("city", List.of(
          new DataColumnFixed("id", DataColumn.Cardinality.REQUIRED, typeFactory.createSqlType(org.apache.calcite.sql.type.SqlTypeName.INTEGER)),
          new DataColumnFixed("name", DataColumn.Cardinality.OPTIONAL, typeFactory.createSqlType(org.apache.calcite.sql.type.SqlTypeName.VARCHAR)),
          new DataColumnFixed("geometry", DataColumn.Cardinality.OPTIONAL, typeFactory.createSqlType(org.apache.calcite.sql.type.SqlTypeName.GEOMETRY))));
      ...
      DataSchema populationSchema = new DataSchema("population", List.of(
          new DataColumnFixed("city_id", DataColumn.Cardinality.REQUIRED, typeFactory.createSqlType(org.apache.calcite.sql.type.SqlTypeName.INTEGER)),
          new DataColumnFixed("population", DataColumn.Cardinality.OPTIONAL, typeFactory.createSqlType(org.apache.calcite.sql.type.SqlTypeName.INTEGER))));
