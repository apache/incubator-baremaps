...
public class OpenStreetMapGeometriesBenchmark {
  ...
  public void rocksdb() throws IOException, RocksDBException {
    ...
    ColumnFamilyDescriptor coordinatesCFD =
        new ColumnFamilyDescriptor("coordinates".getBytes(), new ColumnFamilyOptions());
    ColumnFamilyDescriptor referencesCFD =
        new ColumnFamilyDescriptor("references".getBytes(), new ColumnFamilyOptions());
    ...
    List<ColumnFamilyDescriptor> columnFamilyDescriptors =
        List.of(defaultCFD, coordinatesCFD, referencesCFD);
    List<ColumnFamilyHandle> columnFamilyHandles = new ArrayList<>();
    try (DBOptions options = new DBOptions();
        RocksDB db =
            RocksDB.open(
                options, cacheDirectory.toString(), columnFamilyDescriptors, columnFamilyHandles)) {
      Cache<Long, Coordinate> coordinateCache =
          new RocksdbCache(
