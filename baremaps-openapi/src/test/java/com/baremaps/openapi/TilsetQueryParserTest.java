...
public class TilsetQueryParserTest {
  ...
  void sameQueries() {
    ...
    Layer a = new Layer();
    a.setId("a");
    a.setQueries(Arrays.asList(q));

    Layer b = new Layer();
    b.setId("b");
    b.setQueries(Arrays.asList(q));

    TileSet tileset = new TileSet();
    tileset.setLayers(Arrays.asList(a, b));

    String query = TilesetQueryParser.parse(tileset, new Tile(0, 0, 10));
