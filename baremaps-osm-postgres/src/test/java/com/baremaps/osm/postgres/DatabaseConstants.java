...
public class DatabaseConstants {
  ...
  public static final Relation RELATION_0 = new Relation(
      0, INFO, ImmutableMap.of(), ImmutableList.of(), null);

  public static final Relation RELATION_1 = new Relation(
      1, INFO, ImmutableMap.of("type", "multipolygon"), ImmutableList.of(), null);
